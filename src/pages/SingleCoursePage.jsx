...
const SingleCoursePage = () => {
  ...
  return (
    <SingleCourseWrapper>
      ...
      <Helmet>
        <title>{course_name ? `${course_name} | Course Details` : "Course Details"}</title>
        <meta name="description" content={description || "Explore this course to learn more about its features and benefits."} />
      </Helmet>
