...
const CartPage = () => {
  ...
  if (cartItems.length < 1) {
    return (
      <NotFoundWrapper>
        <Helmet>
          <title>Coursean – Your Cart is Empty</title>
          <meta name="description" content="Your Coursean cart is currently empty. Start exploring and add courses to enhance your learning journey!" />
        </Helmet>
  ...
  return (
    <CartWrapper>
      <Helmet>
        <title>Coursean – Your Shopping Cart</title>
        <meta name="title" content="Coursean – Your Shopping Cart" />
        <meta
          name="description"
          content="Review your selected courses and proceed to checkout. Complete your learning journey with the best courses from Coursean!"
        />
      </Helmet>
